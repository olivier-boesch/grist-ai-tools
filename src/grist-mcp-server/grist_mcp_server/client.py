...
class GristClient:
    ...
    def update_org(self, org_id: str | int, name: str) -> Any:
        return self._request("PATCH", f"/orgs/{org_id}", json={"name": name})

    def delete_org(self, org_id: str | int) -> Any:
        return self._request("DELETE", f"/orgs/{org_id}")

    def list_org_access(self, org_id: str | int) -> Any:
        return self._request("GET", f"/orgs/{org_id}/access")

    def update_org_access(self, org_id: str | int, users: dict[str, str | None]) -> Any:
    ...
    def list_workspaces(self, org_id: str | int) -> Any:
        return self._request("GET", f"/orgs/{org_id}/workspaces")

    def get_workspace(self, workspace_id: str | int) -> Any:
        return self._request("GET", f"/workspaces/{workspace_id}")

    def create_workspace(self, org_id: str | int, name: str) -> Any:
        return self._request(
            "POST", f"/orgs/{org_id}/workspaces", json={"name": name}
        )

    def update_workspace(self, workspace_id: str | int, name: str) -> Any:
        return self._request(
            "PATCH", f"/workspaces/{workspace_id}", json={"name": name}
        )

    def delete_workspace(self, workspace_id: str | int) -> Any:
        return self._request("DELETE", f"/workspaces/{workspace_id}")

    def list_workspace_access(self, workspace_id: str | int) -> Any:
        return self._request("GET", f"/workspaces/{workspace_id}/access")

    def update_workspace_access(
        self, workspace_id: str | int, users: dict[str, str | None]
    ) -> Any:
        return self._request(
            "PATCH",
    ...
    def create_doc(self, workspace_id: str | int, name: str) -> Any:
        return self._request(
    ...
    def update_records(
        ...
        """records: [{"id": 1, "fields": {"ColName": value, ...}}]"""
        return self._request(
            "PATCH",
            f"/docs/{doc_id}/tables/{table_id}/records",
            json={"records": records},
